...
const FindUserByIdError_1 = require("./FindUserByIdError");
    ...
    execute(id) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.usersRepository.validateId(id)) {
                throw new FindUserByIdError_1.FindUserByIdError.InvalidId();
            }
            const user = yield this.usersRepository.findById(id);
            if (!user) {
                throw new FindUserByIdError_1.FindUserByIdError.UserNotFound();
            }
            return user;
        });
    }
